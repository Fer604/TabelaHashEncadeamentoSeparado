...
public class testeDesempenho {
    ...
    public static void executar(tabela tabela, int tamanhoTabela, int[] tamanhosDados, String nomeHash, long seed) {
        ...
        for (int tamanhoDados : tamanhosDados) {
            ...
            // vamos fazer REP repetições das buscas e tirar médias
